...
$sudo nohup bash /usr/local/haproxy/master_ip_check.sh 172.23.0.10 172.23.0.11 &



7 at haproxy node, start slave ip check script. the parameters mean slave server ip addresses.

$sudo nohup bash /usr/local/haproxy/slave_ip_check.sh 172.23.0.11 172.23.0.12 &
