...
secondary_check_script= masterha_secondary_check -s 172.23.0.11 -s 172.23.0.12
ping_interval=1
...
[server2]
hostname=172.23.0.11
candidate_master=1

[server3]
hostname=172.23.0.12
no_master=1
EOF
...
backend mysqlwritepool                    
       balance roundrobin
       server  mysql01 172.23.0.10:3306  weight 5 check inter 2000 rise 2 fall 3

backend mysqlreadpool                    
       balance roundrobin
        server  172.23.0.11 172.23.0.11:3306  weight 5 check inter 2000 rise 2 fall 3
        server  172.23.0.12 172.23.0.12:3306  weight 5 check inter 2000 rise 2 fall 3
EOF
