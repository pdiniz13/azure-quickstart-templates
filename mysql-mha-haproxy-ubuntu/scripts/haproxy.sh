...
secondary_check_script= masterha_secondary_check -s 10.64.0.11 -s 10.64.0.12
ping_interval=1
...
backend mysqlwritepool                    
       balance roundrobin
       server  mysql01 10.64.0.10:3306  weight 5 check inter 2000 rise 2 fall 3

backend mysqlreadpool                    
       balance roundrobin
        server  10.64.0.11 10.64.0.11:3306  weight 5 check inter 2000 rise 2 fall 3
        server  10.64.0.12 10.64.0.12:3306  weight 5 check inter 2000 rise 2 fall 3
EOF
