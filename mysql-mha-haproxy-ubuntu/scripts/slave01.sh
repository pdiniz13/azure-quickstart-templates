...
sed -i 's/server-id.*/server-id = 2/' /etc/mysql/my.cnf
...
mysql -uroot -p$mysqlPassword -e "change master to master_host='10.128.0.10',master_user='repluser',master_password='replpass';start slave;"
